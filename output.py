...
def write_output(outfile, island_list, ISLAND_SCORE_THRESHOLD):
    f = open(outfile, 'wb')
    logging.info("Line in BED file: 'chromosome_name\tisland_start\tisland_end\tisland_score\tnumber_of_reads_in_the_island\tisland_number_of_eligible_windows\tnumber_of_gaps_in_the_island'")
